...
from .logistic.bin_schema import BaseStrictSchema, BinPlainSchema
...
from .logistic.warehouse_schema import (WarehousePlainSchema,
                                        WarehouseStrictSchema)
from .trade.assoc_schema import (AssocCategoryDiscountStrictSchema,
...
from .trade.exchange_rate_schema import (ExchangeRatePlainSchema,
...
from .trade.payment_method_schema import (PaymentMethodPlainSchema,
