...
class CreateOrderView(BaseView["CreateOrderController"]):
    ...
    def __apply_card_size(self) -> None:
        ...
        if page.web:
            ...
            viewport_width = page.window.width or page.width
            viewport_height = page.window.height or page.height
    ...
    def __register_card_resize_handler(self) -> None:
        page = self._controller._page
        if not page.web or self.__card_resize_handler is not None:
            return
    ...
    def open_cart_dialog(self) -> None:
        ...
        def resolve_viewport() -> tuple[int | None, int | None]:
            ...
            return (page.window.width or page.width, page.window.height or page.height)
        ...
        if page.web and self.__cart_resize_handler is None:
