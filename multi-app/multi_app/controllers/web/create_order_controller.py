...
class CreateOrderController(
    ...
    def __convert_to_order_currency(self, amount: float, source_currency_id: int | None) -> float:
        return self.__convert_to_currency(amount, source_currency_id, self.__order_currency_id, raise_on_missing=True)
    ...
    def __convert_between_currencies(self, amount: float, source_currency_id: int, target_currency_id: int) -> float:
        return self.__convert_to_currency(amount, source_currency_id, target_currency_id, raise_on_missing=False)
