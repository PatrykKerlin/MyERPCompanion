...
class Constraints:
    ...
    PositiveIntegerListOptional = Annotated[  # NOSONAR
    ...
    NonNegativeNumeric_10_2 = Annotated[  # NOSONAR
        float, BeforeValidator(__none_to_zero), Field(ge=0, lt=100000000, default=0)
    ]
    ...
    PhoneNumberOptional = Annotated[  # NOSONAR
        str | None, Field(min_length=9, max_length=20, pattern=__phone_number_regex)
    ]
    PostalCode = Annotated[str, Field(min_length=6, max_length=6, pattern=__postal_code_regex)]  # NOSONAR
    PostalCodeOptional = Annotated[  # NOSONAR
        str | None, Field(min_length=6, max_length=6, pattern=__postal_code_regex)
    ]
