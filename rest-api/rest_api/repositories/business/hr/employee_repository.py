...
class EmployeeRepository(BaseRepository[Employee]):
    ...
    def _build_query(
        ...
        return query.options(
            ...
            with_loader_criteria(Position, cls._expr(Position.is_active == True)),
            with_loader_criteria(User, cls._expr(User.is_active == True)),
            with_loader_criteria(Employee, cls._expr(Employee.is_active == True)),
        )
