...
from base.models.themes_text_choices import ThemesTextChoices
...
class User(BaseModel, AbstractBaseUser, PermissionsMixin):
    ...
    login = models.CharField(max_length=6, null=True)
    is_staff = models.BooleanField(default=False)
    is_superuser = models.BooleanField(default=False)

    theme = models.CharField(max_length=5, choices=ThemesTextChoices.choices, default=Themes.DARK)
