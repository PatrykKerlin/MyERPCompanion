...
class Employee(BaseModel):
    ...
    __table_args__ = (
        Index("ux_employee_pesel_active_true", "pesel", unique=True, postgresql_where=text("is_active")),
        Index(
            "ux_employee_passport_number_active_true",
            "passport_number",
            unique=True,
            postgresql_where=text("is_active"),
        ),
        Index(
            "ux_employee_id_card_number_active_true", "id_card_number", unique=True, postgresql_where=text("is_active")
        ),
        Index("ux_employee_email_active_true", "email", unique=True, postgresql_where=text("is_active")),
        Index("ux_employee_phone_number_active_true", "phone_number", unique=True, postgresql_where=text("is_active")),
    )
