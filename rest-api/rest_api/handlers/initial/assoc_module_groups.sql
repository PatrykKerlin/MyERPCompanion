...
(1, 10, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
...
(3, 3, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(3, 6, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(4, 1, TRUE, FALSE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(4, 6, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(4, 7, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(4, 10, TRUE, FALSE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
...
(7, 2, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id);
