...
(4, 1, TRUE, FALSE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(4, 5, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(5, 1, TRUE, FALSE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(5, 6, TRUE, TRUE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
(6, 1, TRUE, FALSE, TRUE, CURRENT_TIMESTAMP, :superuser_id),
