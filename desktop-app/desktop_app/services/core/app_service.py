...
from config.enums import TextKey, Endpoint
...
class AppService(BaseService):
    async def api_health_check(self) -> None:
        ...
        raise TimeoutError(self._context.texts[TextKey.API_NOT_RESPONDING])
    ...
    async def fetch_texts(self) -> dict[str, str]:
        ...
        while True:
            response = await self._get(
                f"{Endpoint.TEXTS_BY_LANGUAGE}/{self._context.settings.LANGUAGE}",
