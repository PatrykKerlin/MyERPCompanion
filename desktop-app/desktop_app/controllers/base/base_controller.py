...
class BaseController:
    ...
    def add_unsubscriber(self, func: Callable[[], None]) -> None:
        self._unsubscribers.append(func)
    ...
    async def dispose(self) -> None:
        ...
        while self._unsubscribers:
            func = self._unsubscribers.pop()
            func()

    def _show_loading_dialog(self) -> LoadingDialogComponent:
        loading_dialog = LoadingDialogComponent(self._context.state_store.get().translation.items)
