...
class AppView:
    def __init__(self, page: ft.Page, translation: dict[str, str]) -> None:
        self._page = page
        self._translation = translation
        self._label = ft.Text(value="Starting...")
        self._page.title = self._translation["my_erp_companion"]
        self._page.add(self._label)

    def update_translation(self, translation: dict[str, str]) -> None:
        self._translation = translation
        self._page.update()

    def set_ready(self) -> None:
        self._label.value = "App is ready!"
        self._page.update()
